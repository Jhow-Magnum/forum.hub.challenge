...
class TopicsControllerTest {
    ...
    private MockMvc mvc;
    @Autowired
    private JacksonTester<api.forum.hub.domain.dto.RegistrationTopicRequest> cadastroTopicoRequestJson;
    @Autowired
    private JacksonTester<api.forum.hub.domain.dto.DetailsTopicResponse> detalhesTopicoResponseJson;
    @Autowired
    private JacksonTester<api.forum.hub.domain.dto.RequestUpdateTopics> atualizacaoTopicoRequestJson;
    @MockBean
    ...
    void deveRetornar200QuandoListarEHouverTopicoCadastrado() throws Exception {
        // Given
        List<api.forum.hub.domain.Topics> topicosCadastrados = Arrays.asList(criaTopicoCompleto());
        Page<api.forum.hub.domain.Topics> pageComTopico = new PageImpl<>(topicosCadastrados, Pageable.unpaged(), topicosCadastrados.size());
    ...
    void deveRetornar200QuandoListarENaoHouverTopicoCadastrado() throws Exception {
        // Given
        List<api.forum.hub.domain.Topics> emptyList = new ArrayList<>();
        Pageable pageable = Pageable.unpaged();
        Page<api.forum.hub.domain.Topics> emptyPage = new PageImpl<>(emptyList, pageable, 0);
